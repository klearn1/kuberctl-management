...
func For(client clientset.Interface, cfg *kubeadmapi.JoinConfiguration, isDryRun bool) (*clientcmdapi.Config, error) {
	...
	config, err := DiscoverValidatedKubeConfig(client, cfg, isDryRun)
	if err != nil {
...
func DiscoverValidatedKubeConfig(dryRunClient clientset.Interface, cfg *kubeadmapi.JoinConfiguration, isDryRun bool) (*clientcmdapi.Config, error) {
