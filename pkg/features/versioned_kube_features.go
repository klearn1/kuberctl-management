...
var defaultVersionedKubernetesFeatureGates = map[featuregate.Feature]featuregate.VersionedSpecs{
	...
	AppArmor: {
		{Version: version.MustParse("1.4"), Default: false, PreRelease: featuregate.Beta},
	...
	CPUManager: {
		...
		{Version: version.MustParse("1.10"), Default: false, PreRelease: featuregate.Beta},
	...
	RetryGenerateName: {
		{Version: version.MustParse("1.30"), Default: true, PreRelease: featuregate.Alpha},
