...
// GetPluginRegistrationHandler provides a mock function with given fields:
func (_m *MockContainerManager) GetPluginRegistrationHandler() cache.PluginHandler {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetPluginRegistrationHandler")
	}

	var r0 cache.PluginHandler
	if rf, ok := ret.Get(0).(func() cache.PluginHandler); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(cache.PluginHandler)
		}
	}
...
// MockContainerManager_GetPluginRegistrationHandler_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPluginRegistrationHandler'
type MockContainerManager_GetPluginRegistrationHandler_Call struct {
	*mock.Call
}

// GetPluginRegistrationHandler is a helper method to define mock.On call
func (_e *MockContainerManager_Expecter) GetPluginRegistrationHandler() *MockContainerManager_GetPluginRegistrationHandler_Call {
	return &MockContainerManager_GetPluginRegistrationHandler_Call{Call: _e.mock.On("GetPluginRegistrationHandler")}
}

func (_c *MockContainerManager_GetPluginRegistrationHandler_Call) Run(run func()) *MockContainerManager_GetPluginRegistrationHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockContainerManager_GetPluginRegistrationHandler_Call) Return(_a0 cache.PluginHandler) *MockContainerManager_GetPluginRegistrationHandler_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockContainerManager_GetPluginRegistrationHandler_Call) RunAndReturn(run func() cache.PluginHandler) *MockContainerManager_GetPluginRegistrationHandler_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetResources provides a mock function with given fields: pod, _a1
func (_m *MockContainerManager) GetResources(pod *corev1.Pod, _a1 *corev1.Container) (*container.RunContainerOptions, error) {
	ret := _m.Called(pod, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*corev1.Pod, *corev1.Container) (*container.RunContainerOptions, error)); ok {
		return rf(pod, _a1)
	}
	if rf, ok := ret.Get(0).(func(*corev1.Pod, *corev1.Container) *container.RunContainerOptions); ok {
		r0 = rf(pod, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*corev1.Pod, *corev1.Container) error); ok {
		r1 = rf(pod, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
//   - pod *corev1.Pod
//   - _a1 *corev1.Container
func (_e *MockContainerManager_Expecter) GetResources(pod interface{}, _a1 interface{}) *MockContainerManager_GetResources_Call {
	return &MockContainerManager_GetResources_Call{Call: _e.mock.On("GetResources", pod, _a1)}
}

func (_c *MockContainerManager_GetResources_Call) Run(run func(pod *corev1.Pod, _a1 *corev1.Container)) *MockContainerManager_GetResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*corev1.Pod), args[1].(*corev1.Container))
	})
	return _c
...
func (_c *MockContainerManager_GetResources_Call) RunAndReturn(run func(*corev1.Pod, *corev1.Container) (*container.RunContainerOptions, error)) *MockContainerManager_GetResources_Call {
	_c.Call.Return(run)
	return _c
}
...
// PrepareDynamicResources provides a mock function with given fields: _a0
func (_m *MockContainerManager) PrepareDynamicResources(_a0 *corev1.Pod) error {
	ret := _m.Called(_a0)
...
//   - _a0 *corev1.Pod
func (_e *MockContainerManager_Expecter) PrepareDynamicResources(_a0 interface{}) *MockContainerManager_PrepareDynamicResources_Call {
	return &MockContainerManager_PrepareDynamicResources_Call{Call: _e.mock.On("PrepareDynamicResources", _a0)}
}

func (_c *MockContainerManager_PrepareDynamicResources_Call) Run(run func(_a0 *corev1.Pod)) *MockContainerManager_PrepareDynamicResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockContainerManager_PrepareDynamicResources_Call) RunAndReturn(run func(*corev1.Pod) error) *MockContainerManager_PrepareDynamicResources_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockContainerManager) Start(_a0 *corev1.Node, _a1 cm.ActivePodsFunc, _a2 config.SourcesReady, _a3 status.PodStatusProvider, _a4 cri.RuntimeService, _a5 bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*corev1.Node, cm.ActivePodsFunc, config.SourcesReady, status.PodStatusProvider, cri.RuntimeService, bool) error); ok {
...
//   - _a0 *corev1.Node
//   - _a1 cm.ActivePodsFunc
//   - _a2 config.SourcesReady
//   - _a3 status.PodStatusProvider
//   - _a4 cri.RuntimeService
//   - _a5 bool
func (_e *MockContainerManager_Expecter) Start(_a0 interface{}, _a1 interface{}, _a2 interface{}, _a3 interface{}, _a4 interface{}, _a5 interface{}) *MockContainerManager_Start_Call {
	return &MockContainerManager_Start_Call{Call: _e.mock.On("Start", _a0, _a1, _a2, _a3, _a4, _a5)}
}

func (_c *MockContainerManager_Start_Call) Run(run func(_a0 *corev1.Node, _a1 cm.ActivePodsFunc, _a2 config.SourcesReady, _a3 status.PodStatusProvider, _a4 cri.RuntimeService, _a5 bool)) *MockContainerManager_Start_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*corev1.Node), args[1].(cm.ActivePodsFunc), args[2].(config.SourcesReady), args[3].(status.PodStatusProvider), args[4].(cri.RuntimeService), args[5].(bool))
	})
	return _c
}
...
func (_c *MockContainerManager_Start_Call) RunAndReturn(run func(*corev1.Node, cm.ActivePodsFunc, config.SourcesReady, status.PodStatusProvider, cri.RuntimeService, bool) error) *MockContainerManager_Start_Call {
	_c.Call.Return(run)
	return _c
}
...
// UnprepareDynamicResources provides a mock function with given fields: _a0
func (_m *MockContainerManager) UnprepareDynamicResources(_a0 *corev1.Pod) error {
	ret := _m.Called(_a0)
...
//   - _a0 *corev1.Pod
func (_e *MockContainerManager_Expecter) UnprepareDynamicResources(_a0 interface{}) *MockContainerManager_UnprepareDynamicResources_Call {
	return &MockContainerManager_UnprepareDynamicResources_Call{Call: _e.mock.On("UnprepareDynamicResources", _a0)}
}

func (_c *MockContainerManager_UnprepareDynamicResources_Call) Run(run func(_a0 *corev1.Pod)) *MockContainerManager_UnprepareDynamicResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*corev1.Pod))
	})
	return _c
...
func (_c *MockContainerManager_UnprepareDynamicResources_Call) RunAndReturn(run func(*corev1.Pod) error) *MockContainerManager_UnprepareDynamicResources_Call {
	_c.Call.Return(run)
	return _c
}
