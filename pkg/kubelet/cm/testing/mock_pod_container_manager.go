...
// SetPodCgroupConfig provides a mock function with given fields: pod, resource, resourceConfig
func (_m *MockPodContainerManager) SetPodCgroupConfig(pod *v1.Pod, resource v1.ResourceName, resourceConfig *cm.ResourceConfig) error {
	ret := _m.Called(pod, resource, resourceConfig)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*v1.Pod, v1.ResourceName, *cm.ResourceConfig) error); ok {
		r0 = rf(pod, resource, resourceConfig)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockPodContainerManager_Expecter) SetPodCgroupConfig(pod interface{}, resource interface{}, resourceConfig interface{}) *MockPodContainerManager_SetPodCgroupConfig_Call {
	return &MockPodContainerManager_SetPodCgroupConfig_Call{Call: _e.mock.On("SetPodCgroupConfig", pod, resource, resourceConfig)}
}

func (_c *MockPodContainerManager_SetPodCgroupConfig_Call) Run(run func(pod *v1.Pod, resource v1.ResourceName, resourceConfig *cm.ResourceConfig)) *MockPodContainerManager_SetPodCgroupConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1.Pod), args[1].(v1.ResourceName), args[2].(*cm.ResourceConfig))
	})
	return _c
}
...
func (_c *MockPodContainerManager_SetPodCgroupConfig_Call) RunAndReturn(run func(*v1.Pod, v1.ResourceName, *cm.ResourceConfig) error) *MockPodContainerManager_SetPodCgroupConfig_Call {
	_c.Call.Return(run)
	return _c
}
