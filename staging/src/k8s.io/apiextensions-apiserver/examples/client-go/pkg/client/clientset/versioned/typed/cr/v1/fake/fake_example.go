...
import (
	...
	clientset "k8s.io/apiextensions-apiserver/examples/client-go/pkg/client/clientset/versioned/typed/cr/v1"
...
func newFakeExamples(fake *FakeCrV1, namespace string) clientset.ExampleInterface {
	return &fakeExamples{
