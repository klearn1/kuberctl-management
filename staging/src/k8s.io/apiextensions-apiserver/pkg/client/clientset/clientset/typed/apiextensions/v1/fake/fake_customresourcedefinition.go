...
import (
	...
	clientset "k8s.io/apiextensions-apiserver/pkg/client/clientset/clientset/typed/apiextensions/v1"
...
func newFakeCustomResourceDefinitions(fake *FakeApiextensionsV1) clientset.CustomResourceDefinitionInterface {
