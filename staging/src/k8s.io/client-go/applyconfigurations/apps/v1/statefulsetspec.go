...
type StatefulSetSpecApplyConfiguration struct {
	...
	VolumeClaimUpdatePolicy              *appsv1.StatefulSetVolumeClaimUpdatePolicyType                     `json:"volumeClaimUpdatePolicy,omitempty"`
}
...
func (b *StatefulSetSpecApplyConfiguration) WithVolumeClaimUpdatePolicy(value appsv1.StatefulSetVolumeClaimUpdatePolicyType) *StatefulSetSpecApplyConfiguration {
