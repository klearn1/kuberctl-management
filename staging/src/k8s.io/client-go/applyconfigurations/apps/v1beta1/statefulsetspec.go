...
type StatefulSetSpecApplyConfiguration struct {
	...
	VolumeClaimUpdatePolicy              *v1beta1.StatefulSetVolumeClaimUpdatePolicyType                    `json:"volumeClaimUpdatePolicy,omitempty"`
}
...
func (b *StatefulSetSpecApplyConfiguration) WithVolumeClaimUpdatePolicy(value v1beta1.StatefulSetVolumeClaimUpdatePolicyType) *StatefulSetSpecApplyConfiguration {
