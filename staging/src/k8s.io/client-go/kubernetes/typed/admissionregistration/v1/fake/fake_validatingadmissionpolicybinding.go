...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/admissionregistration/v1"
)
...
func newFakeValidatingAdmissionPolicyBindings(fake *FakeAdmissionregistrationV1) clientset.ValidatingAdmissionPolicyBindingInterface {
