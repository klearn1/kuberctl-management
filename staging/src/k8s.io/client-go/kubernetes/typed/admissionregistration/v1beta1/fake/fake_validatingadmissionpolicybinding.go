...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/admissionregistration/v1beta1"
)
...
func newFakeValidatingAdmissionPolicyBindings(fake *FakeAdmissionregistrationV1beta1) clientset.ValidatingAdmissionPolicyBindingInterface {
