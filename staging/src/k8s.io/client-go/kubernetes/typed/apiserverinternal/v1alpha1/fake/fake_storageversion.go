...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/apiserverinternal/v1alpha1"
)
...
func newFakeStorageVersions(fake *FakeInternalV1alpha1) clientset.StorageVersionInterface {
