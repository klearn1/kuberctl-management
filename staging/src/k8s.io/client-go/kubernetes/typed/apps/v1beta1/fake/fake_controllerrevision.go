...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/apps/v1beta1"
)
...
func newFakeControllerRevisions(fake *FakeAppsV1beta1, namespace string) clientset.ControllerRevisionInterface {
