...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/apps/v1beta2"
)
...
func newFakeControllerRevisions(fake *FakeAppsV1beta2, namespace string) clientset.ControllerRevisionInterface {
