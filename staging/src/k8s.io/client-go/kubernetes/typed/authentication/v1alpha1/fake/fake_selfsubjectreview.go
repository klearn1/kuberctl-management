...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/authentication/v1alpha1"
)
...
func newFakeSelfSubjectReviews(fake *FakeAuthenticationV1alpha1) clientset.SelfSubjectReviewInterface {
