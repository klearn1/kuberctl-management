...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/authentication/v1beta1"
)
...
func newFakeSelfSubjectReviews(fake *FakeAuthenticationV1beta1) clientset.SelfSubjectReviewInterface {
