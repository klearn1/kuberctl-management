...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/authorization/v1"
)
...
func newFakeLocalSubjectAccessReviews(fake *FakeAuthorizationV1, namespace string) clientset.LocalSubjectAccessReviewInterface {
