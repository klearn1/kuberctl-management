...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/authorization/v1beta1"
)
...
func newFakeLocalSubjectAccessReviews(fake *FakeAuthorizationV1beta1, namespace string) clientset.LocalSubjectAccessReviewInterface {
