...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/autoscaling/v1"
)
...
func newFakeHorizontalPodAutoscalers(fake *FakeAutoscalingV1, namespace string) clientset.HorizontalPodAutoscalerInterface {
