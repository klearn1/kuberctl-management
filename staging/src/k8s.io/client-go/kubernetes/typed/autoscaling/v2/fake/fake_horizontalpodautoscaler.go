...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/autoscaling/v2"
)
...
func newFakeHorizontalPodAutoscalers(fake *FakeAutoscalingV2, namespace string) clientset.HorizontalPodAutoscalerInterface {
