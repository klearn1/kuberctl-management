...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/autoscaling/v2beta1"
)
...
func newFakeHorizontalPodAutoscalers(fake *FakeAutoscalingV2beta1, namespace string) clientset.HorizontalPodAutoscalerInterface {
