...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/autoscaling/v2beta2"
)
...
func newFakeHorizontalPodAutoscalers(fake *FakeAutoscalingV2beta2, namespace string) clientset.HorizontalPodAutoscalerInterface {
