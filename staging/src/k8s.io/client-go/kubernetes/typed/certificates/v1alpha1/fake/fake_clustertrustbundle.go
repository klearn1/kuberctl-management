...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/certificates/v1alpha1"
)
...
func newFakeClusterTrustBundles(fake *FakeCertificatesV1alpha1) clientset.ClusterTrustBundleInterface {
