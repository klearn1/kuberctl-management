...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/certificates/v1beta1"
)
...
func newFakeCertificateSigningRequests(fake *FakeCertificatesV1beta1) clientset.CertificateSigningRequestInterface {
