...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/coordination/v1alpha1"
)
...
func newFakeLeaseCandidates(fake *FakeCoordinationV1alpha1, namespace string) clientset.LeaseCandidateInterface {
