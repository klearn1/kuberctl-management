...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/coordination/v1beta1"
)
...
func newFakeLeases(fake *FakeCoordinationV1beta1, namespace string) clientset.LeaseInterface {
	return &fakeLeases{
