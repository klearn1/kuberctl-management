...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/discovery/v1"
)
...
func newFakeEndpointSlices(fake *FakeDiscoveryV1, namespace string) clientset.EndpointSliceInterface {
