...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/discovery/v1beta1"
)
...
func newFakeEndpointSlices(fake *FakeDiscoveryV1beta1, namespace string) clientset.EndpointSliceInterface {
