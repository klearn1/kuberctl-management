...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/flowcontrol/v1beta1"
)
...
func newFakePriorityLevelConfigurations(fake *FakeFlowcontrolV1beta1) clientset.PriorityLevelConfigurationInterface {
