...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/flowcontrol/v1beta2"
)
...
func newFakePriorityLevelConfigurations(fake *FakeFlowcontrolV1beta2) clientset.PriorityLevelConfigurationInterface {
