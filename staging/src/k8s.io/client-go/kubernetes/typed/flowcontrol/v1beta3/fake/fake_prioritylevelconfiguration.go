...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/flowcontrol/v1beta3"
)
...
func newFakePriorityLevelConfigurations(fake *FakeFlowcontrolV1beta3) clientset.PriorityLevelConfigurationInterface {
