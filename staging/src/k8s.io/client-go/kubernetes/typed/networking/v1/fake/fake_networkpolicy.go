...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/networking/v1"
)
...
func newFakeNetworkPolicies(fake *FakeNetworkingV1, namespace string) clientset.NetworkPolicyInterface {
