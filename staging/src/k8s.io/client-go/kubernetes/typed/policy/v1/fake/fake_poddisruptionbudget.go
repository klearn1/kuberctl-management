...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/policy/v1"
)
...
func newFakePodDisruptionBudgets(fake *FakePolicyV1, namespace string) clientset.PodDisruptionBudgetInterface {
