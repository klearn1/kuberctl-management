...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/rbac/v1alpha1"
)
...
func newFakeRoleBindings(fake *FakeRbacV1alpha1, namespace string) clientset.RoleBindingInterface {
