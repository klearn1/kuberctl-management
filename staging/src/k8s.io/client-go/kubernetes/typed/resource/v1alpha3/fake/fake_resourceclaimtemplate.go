...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/resource/v1alpha3"
)
...
func newFakeResourceClaimTemplates(fake *FakeResourceV1alpha3, namespace string) clientset.ResourceClaimTemplateInterface {
