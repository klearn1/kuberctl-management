...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1"
)
...
func newFakePriorityClasses(fake *FakeSchedulingV1alpha1) clientset.PriorityClassInterface {
