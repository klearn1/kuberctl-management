...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/storage/v1alpha1"
)
...
func newFakeCSIStorageCapacities(fake *FakeStorageV1alpha1, namespace string) clientset.CSIStorageCapacityInterface {
