...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/storage/v1beta1"
)
...
func newFakeCSIStorageCapacities(fake *FakeStorageV1beta1, namespace string) clientset.CSIStorageCapacityInterface {
