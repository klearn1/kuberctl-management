...
import (
	...
	clientset "k8s.io/client-go/kubernetes/typed/storagemigration/v1alpha1"
)
...
func newFakeStorageVersionMigrations(fake *FakeStoragemigrationV1alpha1) clientset.StorageVersionMigrationInterface {
