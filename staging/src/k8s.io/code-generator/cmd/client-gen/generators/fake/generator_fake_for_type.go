...
func (g *genFakeForType) Imports(c *generator.Context) (imports []string) {
	...
	imports = append(imports, fmt.Sprintf("clientset \"%s\"", g.realClientPackage))
	return imports
}
...
var newStruct = []string{
	noList | noApply: `
	func newFake$.type|publicPlural$(fake *Fake$.GroupGoName$$.Version$$if .namespaced$, namespace string$end$) $.realClientPackage$.$.type|public$Interface {
...
func (c *fake$.type|publicPlural$) Create(ctx context.Context, $.inputType|private$ *$.inputType|raw$, opts $.CreateOptions|raw$) (result *$.resultType|raw$, err error) {
	emptyResult := &$.resultType|raw${}
	obj, err := c.Fake.
		$if .namespaced$Invokes($.NewCreateActionWithOptions|raw$($.inputType|allLowercasePlural$Resource, c.Namespace(), $.inputType|private$, opts), emptyResult)
...
func (c *fake$.type|publicPlural$) Update(ctx context.Context, $.inputType|private$ *$.inputType|raw$, opts $.UpdateOptions|raw$) (result *$.resultType|raw$, err error) {
	emptyResult := &$.resultType|raw${}
	obj, err := c.Fake.
		$if .namespaced$Invokes($.NewUpdateActionWithOptions|raw$($.inputType|allLowercasePlural$Resource, c.Namespace(), $.inputType|private$, opts), emptyResult)
