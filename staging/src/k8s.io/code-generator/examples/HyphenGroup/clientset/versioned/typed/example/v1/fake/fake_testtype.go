...
import (
	...
	clientset "k8s.io/code-generator/examples/HyphenGroup/clientset/versioned/typed/example/v1"
)
...
func newFakeTestTypes(fake *FakeExampleGroupV1, namespace string) clientset.TestTypeInterface {
