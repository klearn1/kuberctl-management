...
import (
	...
	clientset "k8s.io/code-generator/examples/MixedCase/clientset/versioned/typed/example/v1"
)
...
func newFakeClusterTestTypes(fake *FakeExampleV1) clientset.ClusterTestTypeInterface {
