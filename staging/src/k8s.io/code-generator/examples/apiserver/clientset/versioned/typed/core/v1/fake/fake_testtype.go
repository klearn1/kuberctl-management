...
import (
	...
	clientset "k8s.io/code-generator/examples/apiserver/clientset/versioned/typed/core/v1"
)
...
func newFakeTestTypes(fake *FakeCoreV1, namespace string) clientset.TestTypeInterface {
