...
import (
	...
	clientset "k8s.io/code-generator/examples/apiserver/clientset/versioned/typed/example3.io/v1"
)
...
func newFakeTestTypes(fake *FakeThirdExampleV1, namespace string) clientset.TestTypeInterface {
