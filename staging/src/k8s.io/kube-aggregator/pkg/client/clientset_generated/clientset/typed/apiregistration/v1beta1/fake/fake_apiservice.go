...
import (
	...
	clientset "k8s.io/kube-aggregator/pkg/client/clientset_generated/clientset/typed/apiregistration/v1beta1"
)
...
func newFakeAPIServices(fake *FakeApiregistrationV1beta1) clientset.APIServiceInterface {
