...
import (
	...
	clientset "k8s.io/metrics/pkg/client/clientset/versioned/typed/metrics/v1alpha1"
)
...
func newFakePodMetricses(fake *FakeMetricsV1alpha1, namespace string) clientset.PodMetricsInterface {
