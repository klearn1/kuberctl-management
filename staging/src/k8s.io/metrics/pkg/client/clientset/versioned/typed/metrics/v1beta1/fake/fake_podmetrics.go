...
import (
	...
	clientset "k8s.io/metrics/pkg/client/clientset/versioned/typed/metrics/v1beta1"
)
...
func newFakePodMetricses(fake *FakeMetricsV1beta1, namespace string) clientset.PodMetricsInterface {
