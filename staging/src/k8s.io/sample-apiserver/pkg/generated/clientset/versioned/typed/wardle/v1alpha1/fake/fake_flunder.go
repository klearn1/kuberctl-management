...
import (
	...
	clientset "k8s.io/sample-apiserver/pkg/generated/clientset/versioned/typed/wardle/v1alpha1"
)
...
func newFakeFlunders(fake *FakeWardleV1alpha1, namespace string) clientset.FlunderInterface {
	return &fakeFlunders{
