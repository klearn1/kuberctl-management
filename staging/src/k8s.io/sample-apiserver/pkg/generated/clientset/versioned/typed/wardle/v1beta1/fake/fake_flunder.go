...
import (
	...
	clientset "k8s.io/sample-apiserver/pkg/generated/clientset/versioned/typed/wardle/v1beta1"
)
...
func newFakeFlunders(fake *FakeWardleV1beta1, namespace string) clientset.FlunderInterface {
	return &fakeFlunders{
