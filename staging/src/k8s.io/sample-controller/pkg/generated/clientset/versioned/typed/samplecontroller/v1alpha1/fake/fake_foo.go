...
import (
	...
	clientset "k8s.io/sample-controller/pkg/generated/clientset/versioned/typed/samplecontroller/v1alpha1"
)
...
func newFakeFoos(fake *FakeSamplecontrollerV1alpha1, namespace string) clientset.FooInterface {
	return &fakeFoos{
